...
<body>
        ...
        <div class="container-fluid row">
                ...
                <?php require_once("../controlador/Modificar_estudiante_controlador.php"); ?>
        </div>
        ...
        <form class="col-4" method="POST">
                ...
                <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="id" value="<?php echo $proveedor['id'] ?>" readonly>
                </div>
                <div class="mb-3">
                        <label class="form-label">Nombre/s y Apellido/s</label>
                        <input type="text" class="form-control" name="nombre_apellido" value="<?php echo $proveedor['nombre'] ?>">
                </div>
                <div class="mb-3">
                        <label class="form-label">Empresa</label>
                        <input type="text" class="form-control" name="empresa" value="<?php echo $proveedor['grupo'] ?>">
                </div>
                <div class="mb-3">
                        <label class="form-label">Productos</label>
                        <input type="text" class="form-control" name="productos" value="<?php echo $proveedor['nota'] ?>">
                </div>
                <div class="mb-3">
