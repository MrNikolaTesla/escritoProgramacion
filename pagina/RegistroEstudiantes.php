                                                ...
                                                <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                                <input type="datetime-local" id="fecha" class="form-control" name="fecha" required>
                                                                        </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                                <input type="text" id="centro" class="form-control" name="centro" required>
                                                                        </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                                <input type="text" id="nombre_apellido" class="form-control" name="nombre_apellido" required>
                                                                        </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                                <input type="text" id="numero_cel" class="form-control" name="numero_cel" required>
                                                                        </div>
                                                                </div>
                                                                <div class="form-group row">
